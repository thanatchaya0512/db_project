                ...
                <form method="POST" action="chkregister.php">
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="frist_name" type="text" class="form-control" autocomplete="off" required name="frist_name" autofocus>
                    </div>
                    <div class="form-group col-6">
                      <label for="last_name">Last Name</label>
                      <input id="last_name" type="text" class="form-control"  autocomplete="off" required name="last_name">
                    </div>
                    <div class="form-group col-6">
                    ...
                    <input id="email" type="email" class="form-control"  autocomplete="off" required name="email">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      <label for="password2" class="d-block" required >Password Confirmation</label>
